...
@Component({
  ...
  template: `
    <section class="container px-5 py-24 mx-auto text-gray-700">
      <h1 class="text-3xl font-medium text-gray-900 mb-8 text-center" [innerHTML]="title"></h1>
          ...
          <div class="h-full bg-gradient-to-b from-transparent to-gray-100 pt-6 pb-4 px-8 rounded">
            ...
            <a class="inline-flex items-center ml-4">
              ...
              <span class="flex-grow flex flex-col ml-4">
                <span class="leading-none font-medium text-gray-800" [innerHTML]="testimoni.name"></span>
