    ...
    <section class="text-gray-700">
      <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
          <h1 class="font-medium text-3xl text-gray-900" [innerHTML]="title"></h1>
        ...
        <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg shadow-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
          <h2 class="text-gray-900 text-lg font-medium mb-5" [innerHTML]="caption"></h2>
          ...
          <div class="relative mb-4">
            <label for="anu-email-register-password" class="leading-7 text-sm text-gray-600">Password</label>
            <input type="password" id="anu-email-register-password" name="password" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
          </div>
          <button class="text-white bg-indigo-500 border-0 py-2 px-8 mt-4 focus:outline-none hover:bg-indigo-600 rounded text-lg">Submit</button>
