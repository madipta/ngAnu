      ...
      <div class="max-w-screen-lg px-5 pb-24 pt-8 md:pt-24 mx-auto flex flex-wrap items-start">
        ...
        <div class="lg:w-2/6 md:w-1/2 bg-white rounded-md shadow-lg p-6 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
          ...
          <div class="relative mb-4">
            <label for="anu-email-register-full-name" class="leading-7 text-sm">Full Name</label>
            <input type="text" id="anu-email-register-full-name" name="full-name" class="w-full bg-white rounded border border-gray-400 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
          </div>
          <div class="relative mb-4">
