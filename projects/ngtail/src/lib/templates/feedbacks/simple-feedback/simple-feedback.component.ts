  ...
  template: `
    <section class="text-gray-700 relative">
      <div class="absolute inset-0 bg-gray-300">
        <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map" scrolling="no" [src]="mapUrl | safe" style="filter: grayscale(0.9) contrast(1.2) opacity(0.5);"></iframe>
      </div>
      <div class="container px-5 py-24 mx-auto flex">
        <div class="lg:w-1/3 md:w-1/2 bg-gray-50 rounded-md px-8 pt-6 pb-3 shadow-lg flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
          <h2 class="text-gray-800 text-3xl mb-1 font-semibold" [innerHtml]="caption"></h2>
