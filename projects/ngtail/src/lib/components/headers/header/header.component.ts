...
@Component({
  selector: 'anu-header',
  template: `
    <header class="bg-indigo-700 shadow-xl fixed top-0 left-0 right-0 text-gray-700 body-font shadow z-40">
      <div class="container mx-auto py-3 md:px-4 flex flex-wrap flex-col md:flex-row items-center">
