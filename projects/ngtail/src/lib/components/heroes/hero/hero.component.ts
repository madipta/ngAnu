...
@Component({
  selector: 'anu-hero',
  template: `
    <section class="text-lg text-gray-700 body-font">
      <div class="bg-gradient-to-b from-transparent to-indigo-200 rounded-lg container mx-auto flex pt-12 pb-24 mt-6 md:flex-row flex-col items-center">
